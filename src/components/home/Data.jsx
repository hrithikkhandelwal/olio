...
const Data = () => {
    return(
       <div className="home__data">
         <h1 className="home__title">Ritik Khandelwal
         <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
         ...
         <h3 className="home__subtitle">Associate Software Engineer</h3>
         <p className="home__description">I'm fullstack developer,
          and I'm looking for FullTime opportunities.
         </p>

         <a href="https://www.linkedin.com/in/hrithik-khandelwal-92161117b/" className="button button-flex">
            Say Hello
            <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
